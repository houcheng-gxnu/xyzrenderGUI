...
QPushButton { background-color: #FFFFFF; color: #2C3E50; border: 1px solid #CBD5E1; border-radius: 4px; padding: 6px 16px; font-weight: bold; }
QPushButton:hover { background-color: #F5F5F5; border-color: #90A4AE; }
QPushButton:pressed { background-color: #E0E0E0; }
QPushButton:disabled { background-color: #F5F5F5; color: #B0BEC5; }
QComboBox { border: 1px solid #CBD5E1; border-radius: 4px; padding: 4px 8px; background-color: #FFFFFF; }
QComboBox:focus { border-color: #607D8B; }
...
QHeaderView::section { background: #607D8B; color: #FFFFFF; padding: 4px 8px; font-weight: bold; }
